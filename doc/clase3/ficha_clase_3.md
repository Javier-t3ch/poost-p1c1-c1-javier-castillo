...
- **Nombre:** inventario
- **Responsabilidad principal:** almacenar / disponibilidad de objeto
- **Atributos necesarios:** clasificacion de objetos / 
- **Métodos posibles:** usar capula / agregar items / eliminar items / usar items
